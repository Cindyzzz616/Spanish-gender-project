...
trials <- unique(fix.dat$TOI)

# Build a table with all 32 × 96 combinations
all_combos <- expand_grid(Participant = participants, TOI = trials)
...
*Update* actually, now that we added the missing rows back in, there could be rows where FixP=0 in all 3 columns
And the pivoted data should be fine after normalization - we'll just have rows with more than 1 non-zero AOI columns
