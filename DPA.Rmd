...
### Concatenated plot by Determiner Type (from here until the end of section 3, it is generating the older plots before normalization)
...
#### Bootstrap function using lmer (this should be where the error occurred)
